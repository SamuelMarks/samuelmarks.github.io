import { m as Ke } from "./main-BIlw4j2H.js";
/*!-----------------------------------------------------------------------------
      ...
      case 47:
        ...
        if (e.charCodeAt(r + 1) === 47) {
          for (r += 2; r < i && !j(e.charCodeAt(r)); )
            r++;
          return t = e.substring(A, r), s = 12;
        }
        if (e.charCodeAt(r + 1) === 42) {
          r += 2;
          for (var I = i - 1, E = !1; r < I; ) {
            var k = e.charCodeAt(r);
          ...
          return E || (r++, g = 1), t = e.substring(A, r), s = 13;
        }
