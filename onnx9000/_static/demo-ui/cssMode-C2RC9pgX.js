import { m as Le } from "./main-Mf2qmUsB.js";
/*!-----------------------------------------------------------------------------
 ...
 *-----------------------------------------------------------------------------*/
var je = Object.defineProperty, Ne = Object.getOwnPropertyDescriptor, We = Object.getOwnPropertyNames, Oe = Object.prototype.hasOwnProperty, Ue = (e, n, i, r) => {
  if (n && typeof n == "object" || typeof n == "function")
    for (let t of We(n))
      !Oe.call(e, t) && t !== i && je(e, t, { get: () => n[t], enumerable: !(r = Ne(n, t)) || r.enumerable });
  return e;
}, Ve = (e, n, i) => (Ue(e, n, "default"), i), c = {};
Ve(c, Le);
...
function Me(e) {
  return {
    ...
    tags: e.tags ?? [],
    children: (e.children ?? []).map((n) => Me(n))
  };
}
function Se(e) {
...
var pt = class {
  ...
  provideDocumentRangeFormattingEdits(e, n, i, r) {
    const t = e.uri;
    return this._worker(t).then((a) => a.format(t.toString(), Pe(n), Te(i)).then((o) => {
      if (!(!o || o.length === 0))
        return o.map(L);
    }));
  }
...
var ft = class {
  ...
  provideColorPresentations(e, n, i) {
    ...
    return this._worker(r).then(
      (t) => t.getColorPresentations(r.toString(), n.color, Pe(n.range))
    ).then((t) => {
      if (t)
        return t.map((a) => {
          let o = {
